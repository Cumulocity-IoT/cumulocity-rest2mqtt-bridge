...
public class ConfigurationService {
    private static final String OPTION_CATEGORY_CONFIGURATION = "mqttforwarding.configuration";

    private static final String OPTION_KEY_CONFIGURATION = "credentials.mqttforwarding.configuration";
